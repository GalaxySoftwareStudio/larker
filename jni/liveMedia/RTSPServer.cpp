...
RTSPServer::RTSPServer(UsageEnvironment &env,
    ...
    : GenericMediaServer(env, ourSocket, ourPort),
      fHTTPServerSocket(-1), fHTTPServerPort(9081),
...
void RTSPServer::stopTCPStreamingOnSocket(int socketNum)
{
  ...
  if (sotcp != NULL)
  {
    do
    {
      ...
      RTSPClientSession *clientSession = (RTSPServer::RTSPClientSession *)(fClientSessions->Lookup(sessionIdStr));
